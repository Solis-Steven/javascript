...
Seguro.prototype.cotizarSeguro = function() {
    ...
    */
    ...
    /*
        Si el seguro es basico se multipa por un 30% mas 
        Si el seguro es completo se multipa por un 50% mas 
    */
...
UI.prototype.llenarOpciones = () => {
    ...
    const selesctYear = document.querySelector('#year');

    for(let i = max; i > min; i--) {
        let option = document.createElement('option');
        option.value = i;
        option.textContent = i
        selesctYear.appendChild(option);
    }
}
...
function cotizarSeguro(e) {
    ...
    // Utiliazar el prototype que va a utilizar
